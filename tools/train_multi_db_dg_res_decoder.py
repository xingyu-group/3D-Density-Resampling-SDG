...
from train_utils.train_single_db_dg_AE import train_model
from train_utils.train_multi_db_dg_AE import train_multi_db_model
...
def main():
    ...
    if cfg.get('MULTI_DB', None):
        ...
        source_set_2 = source_loader_2 = source_sampler_2 = []
    ...
    # freezed all modules
    frozen_modules = ['vfe', 'backbone_3d', #  'decoder_3d',
        'map_to_bev_module', 
