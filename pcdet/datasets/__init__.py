...
def build_dataloader(dataset_cfg, class_names, batch_size, dist, root_path=None, workers=4,
                     logger=None, training=True, merge_all_iters_to_one_epoch=False, total_epochs=0, shuffle_sample_training=True):
    ...
    if dist:
        if training and shuffle_sample_training:
    ...
    dataloader = DataLoader(
        ...
        shuffle=(sampler is None) and (training and shuffle_sample_training), collate_fn=dataset.collate_batch,
